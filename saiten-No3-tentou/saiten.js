...
function Answer_Check(ans) {
    ...
    if (Qcnt == Question.length) {
        ...
        if(Q2 == "正解"){
            ...
            A2.textContent += Q2 + "です。正解の選択肢は【" + Explain[1][6] + "】です。今回のAさんの動画の状況を踏まえると、左麻痺に関連することを伝える必要があると判断できます。";
        }
        //3個目の解説文を作成する
        ...
        if(Q3 == "正解"){
            ...
            A3.textContent += Q3 + "です。正解の選択肢は【" + Explain[2][6] + "】です。動画から今回この状況の評価として正しいのは、Aさんが左麻痺であること、Aさんがベットの付近で倒れていること、その他ベットにAさんが倒れたと判断される状況が見られた。という点から今回の選択肢【Aさんは麻痺側からベッドを降りようとしてバランスを崩し転倒したようです。】が正しい選択肢になります。";
        }
        //4個目の解説文を作成する
